...
import com.arwin.pokeapp.databinding.ListItemPokemonBinding
import com.arwin.pokeapp.model.PokemonResult
import com.arwin.pokeapp.utils.NETWORK_VIEW_TYPE
import com.arwin.pokeapp.utils.PRODUCT_VIEW_TYPE
import com.arwin.pokeapp.utils.getPicUrl
...
class PokemonAdapter(private val navigate: (PokemonResult, Int, String?) -> Unit) :
    ...
    inner class ViewHolder(
        ...
        fun bind(pokemonResult: PokemonResult) {
            binding.apply {
                pokemonItemTitle.text = pokemonResult.name.capitalize(Locale.ROOT)
